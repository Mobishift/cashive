...
guard :concat, :type => "css", :files => %w[admin campaigns devise flash navbar primitives reset theme users], :input_dir => "public/css", :output => "public/css/styles.min"

guard :concat, :type => "js", :files => %w[admin campaigns main], :input_dir => "public/js", :output => "public/js/scripts.min"
